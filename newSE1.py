...
#Gives you the option to change the excluded brands 
...
#Gives you the option to choose between the file that is already cleaned (a) or the one that the categiories must be stripped
while True:
